...
#Format data to an appropriate format
...
#Cluster data to identify Boroughs based on coordinates (We know there are 5 boroughs)
clusters <- kmeans(data14[,2:3], 5)

str(clusters)

#Add in a Borough number to the dataset
